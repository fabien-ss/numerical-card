 ...
 * @author PRO112
 */
@WebServlet(name = "getDevise", urlPatterns = {"/getDevise"})
public class getDevise extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object banques = (List<Devise>) getDevise.getServiceFoncierRemote().getAllDevise();
            Gson gson = new Gson();        
